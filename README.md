...
This fork adds RTMP support by installing Debian's `libnginx-mod-rtmp` package during the Docker image build and enabling it with a startup module.

### New variables

| Variable | Default | Description |
|---|---:|---|
| `RTMP_STATUS` | `0` | Enable (`1`) or disable (`0`) RTMP on startup |
| `RTMP_PORT` | `1935` | RTMP ingest port |
| `RTMP_APPLICATION` | `live` | RTMP application name |
| `RTMP_HLS_PATH` | `/home/container/www/hls` | HLS output folder |
| `RTMP_HLS_FRAGMENT` | `3` | HLS fragment duration in seconds |
| `RTMP_HLS_PLAYLIST_LENGTH` | `60` | HLS playlist duration in seconds |
| `RTMP_RECORD` | `0` | Enable (`1`) or disable (`0`) RTMP recording |
